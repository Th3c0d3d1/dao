...
const Sidebar = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-800 shadow-xl border-r border-gray-200 dark:bg-gray-500 dark:border-gray-700 z-40 transition-colors duration-200"
    >
