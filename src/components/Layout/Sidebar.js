...
const Sidebar = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed left-0 top-0 h-full w-64 bg-gray-50 dark:bg-gray-600 shadow-xl border-r border-gray-200 dark:border-gray-600 z-40 transition-colors duration-200"
    >
      <div className="flex flex-col h-full">
        {/* Logo */}
        <div className="flex items-center px-6 py-4 border-b border-gray-200 dark:bg-gray-400 dark:border-gray-300">
          <div className="flex items-center dark:bg-gray-400">
