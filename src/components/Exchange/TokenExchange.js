              ...
              <div className="bg-gray-50 dark:bg-gray-500 rounded-xl p-3 lg:p-4">
                ...
                <div className="flex items-center space-x-2 lg:space-x-3">
                  <input
                    ...
                    placeholder="0.0"
                    className="flex-1 text-lg lg:text-2xl font-semibold bg-transparent border-none outline-none text-gray-900 dark:text-gray-800 placeholder-gray-400 min-w-0"
                  />
                  <select
                    value={fromToken}
